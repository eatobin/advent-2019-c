...
int pass(void) {
    ...
    int memD[678];
    int memE[678];
    memcpy(memA, memoryConstant, sizeof(memoryConstant));
    memcpy(memB, memoryConstant, sizeof(memoryConstant));
    memcpy(memC, memoryConstant, sizeof(memoryConstant));
    memcpy(memD, memoryConstant, sizeof(memoryConstant));
    memcpy(memE, memoryConstant, sizeof(memoryConstant));
    return 0;
}
