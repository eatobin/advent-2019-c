...
int main(void) {
    ...
    printf("Part A 0 = %d. Correct = 1002\n", intcode.memory[0]);
    printf("Part A 1 = %d. Correct = 4\n", intcode.memory[1]);
    printf("Part A 2 = %d. Correct = 3\n", intcode.memory[2]);
    printf("Part A 3 = %d. Correct = 4\n", intcode.memory[3]);
    printf("Part A 4 = %d. Correct = 99\n", intcode.memory[4]);
    printf("Part A input = %d. Correct = 88\n", intcode.input);
    printf("Part A output = %d. Correct = 20\n", intcode.output);
    printf("\n");
...
//     int jj = instruction[2];
//     switch (jj) {
//         case 0:// c-p-r
//             int y = icP->memory[icP->memory[icP->pointer + offsetC]];
//             return y;
//         case 1:// c-i-r
//             int x = icP->memory[icP->pointer + offsetC];
//             return x;
//         default:
//             return 1;
//     }
...
int opcode(anIntcode *icP, Instruction instruction) {
    ...
    switch (instruction[4]) {
        ...
        case 2:
            // int p = icP->pointer;
            // int j = aParam(icP, instruction);
            // int k = cParam(icP, instruction);
            // int l = bParam(icP, instruction);
            icP->memory[aParam(icP, instruction)] =
